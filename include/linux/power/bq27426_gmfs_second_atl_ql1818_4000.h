...
//this file is generated from bq27426G1_ATL_1953_learned_Rbtweak_DF1_20180511.gm.fs at Sat May 12 15:51:50 2018

#ifndef __BQFS_SECOND_ATL_QL1818_4000_FILE__
#define __BQFS_SECOND_ATL_QL1818_4000_FILE__

#include "bqfs_cmd_type.h"

const bqfs_cmd_t bqfs_second_atl_ql1818_4000[] = {
	{
		.cmd_type	= CMD_W,
		.addr		= 0xAA,
		.reg		= 0x00,
	...
	},
	{
		...
		.addr		= 0xAA,
		.reg		= 0x40,
		.data		= {.bytes = {0x45, 0xF8, 0x00, 0x00, 0x00, 0x81, 0x0F, 0xA0, 0x3A, 0x98, 0x0C, 0xE4, 0x00, 0xC8, 0x00, 0x32, 0x00, 0x14, 0x03, 0xE8, 0x01, 0x01, 0x04, 0x00, 0x0A, 0xFF, 0xCE, 0xFF, 0xCE, 0x00, 0x03, 0x00}},
		.data_len	= 32,
	},
	{
		.cmd_type	= CMD_W,
	...
	},
	{
		...
		.addr		= 0xAA,
		.reg		= 0x40,
		.data		= {.bytes = {0x19, 0x53, 0x11, 0x2E, 0xDD, 0xDD, 0xDD, 0xDD, 0xDF, 0xDF, 0xE1, 0xE2, 0xE4, 0xE2, 0xDC, 0xE6, 0xE5, 0xE9, 0xEC, 0xE4, 0xE5, 0xEA, 0xEA, 0xF2, 0xF3, 0xF7, 0xF7, 0xFA, 0xFA, 0x01, 0xFB, 0x00}},
		.data_len	= 32,
	},
	{
		.cmd_type	= CMD_W,
	...
	},
	{
		...
		.addr		= 0xAA,
		.reg		= 0x40,
		.data		= {.bytes = {0xFC, 0xF7, 0xF4, 0xF6, 0xEE, 0xEC, 0xC7, 0xB3, 0xF2, 0xDA, 0x85, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}},
		.data_len	= 32,
	},
	{
		.cmd_type	= CMD_W,
	...
	},
	{
		...
		.addr		= 0xAA,
		.reg		= 0x40,
		.data		= {.bytes = {0xFA, 0x87, 0x05, 0x05, 0x05, 0x00, 0x03, 0x01, 0x02, 0x01, 0xFE, 0xF9, 0x04, 0x19, 0x01, 0x0E, 0xFF, 0xFF, 0xFF, 0xF4, 0x00, 0x01, 0x03, 0xFF, 0xFF, 0xFE, 0xFE, 0xFD, 0xF5, 0xFE, 0xEC, 0xEE}},
		.data_len	= 32,
	},
	{
		.cmd_type	= CMD_W,
	...
	},
	{
		...
		.addr		= 0xAA,
		.reg		= 0x40,
		.data		= {.bytes = {0xFB, 0x04, 0xFF, 0x0D, 0x0C, 0x53, 0x24, 0xCA, 0x1B, 0xC7, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}},
		.data_len	= 32,
	},
	{
		.cmd_type	= CMD_W,
	...
	},
	{
		...
		.addr		= 0xAA,
		.reg		= 0x40,
		.data		= {.bytes = {0xFF, 0x74, 0x01, 0x0C, 0x03, 0xF3, 0x06, 0x13, 0xF8, 0xEF, 0x17, 0xC7, 0xD3, 0xE8, 0xEE, 0x60, 0x98, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}},
		.data_len	= 32,
	},
	{
		.cmd_type	= CMD_W,
	...
	},
	{
		...
		.addr		= 0xAA,
		.reg		= 0x40,
		.data		= {.bytes = {0xFE, 0xB0, 0x01, 0x00, 0xFF, 0x10, 0xFA, 0xF8, 0xF8, 0xF2, 0x01, 0x07, 0x08, 0x04, 0x24, 0x87, 0x9C, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}},
		.data_len	= 32,
	},
	{
		.cmd_type	= CMD_W,
	...
	},
	{
		...
		.addr		= 0xAA,
		.reg		= 0x40,
		.data		= {.bytes = {0x00, 0x35, 0x00, 0x1D, 0x00, 0x1E, 0x00, 0x23, 0x00, 0x1F, 0x00, 0x1D, 0x00, 0x1F, 0x00, 0x20, 0x00, 0x22, 0x00, 0x27, 0x00, 0x2D, 0x00, 0x31, 0x00, 0x4D, 0x00, 0x24, 0x00, 0x4A, 0x00, 0x00}},
		.data_len	= 32,
	},
	{
		.cmd_type	= CMD_W,
	...
	},
	{
		...
		.addr		= 0xAA,
		.reg		= 0x40,
		.data		= {.bytes = {0x10, 0x0E, 0x0E, 0xDA, 0x0E, 0x94, 0x11, 0x2E, 0x10, 0xFC, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}},
		.data_len	= 32,
	},
	{
		.cmd_type	= CMD_W,
...
//end of const bqfs_cmd_t bqfs_second_atl_ql1818_4000[]
#endif
